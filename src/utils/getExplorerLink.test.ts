...
describe('#getExplorerLink', () => {
  ...
  it('correct for address', () => {
    expect(getExplorerLink(1, 'abc', ExplorerDataType.ADDRESS)).toEqual('https://testnet.cspr.live/account/abc')
  })
  it('unrecognized chain id defaults to mainnet', () => {
    expect(getExplorerLink(2, 'abc', ExplorerDataType.ADDRESS)).toEqual('https://testnet.cspr.live/account/abc')
  })
  it('ropsten', () => {
