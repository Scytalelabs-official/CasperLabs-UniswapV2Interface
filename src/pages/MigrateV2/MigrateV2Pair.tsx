...
import { CurrencyAmount, Fraction, Percent, Price, Token } from '@casperswap/sdk-core'
        ...
        {chainId && migrator && (
          <ExternalLink href={getExplorerLink(chainId, migrator.address, ExplorerDataType.ADDRESS)}>
            <TYPE.blue display="inline">
              <Trans>Casperswap migration contract↗</Trans>
            </TYPE.blue>
          </ExternalLink>
        )}
        .
          ...
          {noLiquidity && (
            <BlueCard style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <TYPE.body fontSize={14} style={{ marginBottom: 8, fontWeight: 500, opacity: 0.8 }} textAlign="center">
                <Trans>
                  You are the first liquidity provider for this Casperswap V3 pool. Your liquidity will migrate at the
          ...
          {largePriceDifference ? (
            <YellowCard>
              ...
              <TYPE.body fontSize={14} style={{ marginTop: 8, fontWeight: 400 }}>
                <Trans>
                  You should only deposit liquidity into Casperswap V3 at a price you believe is correct. <br />
